...
<html lang="en">
  ...
  <h1>Schedule Processing</h1>
    ...
    ?>
    <br><br><br>
    <form action="insertShiEntry.php" method="post">
        Insert SIN of employee who you would like to assign a shift: <input type="text" name="employee_sin"><br>
        Insert start time with the format: <input type="datetime-local" name="start_date"><br>
        Insert end time with the format: <input type="datetime-local" name="end_date"><br>
